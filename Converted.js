function AdditionWithoutCarryOver() {
		var mainMov;
		var addend1=[];
		var addend2=[];
		var carry=[];
...
stopFbSound();
			...
			mainMov.activity.text_msg.gotoAndStopFrame(1);
...
playFbSound("plzAnswer");
			} else if (finAnswer==answer) {
playFbSound("right");
playFbSound("wellDone");
				...
				mainMov.answer_btn.removeEventListener("click",showAnswer_fn);
			} else {
...
playSound("paperFlip");
			mainMov.activity.notebook.gotoAndPlayFrame(2);
